(function(){
  ...
  function manipulateImage(type) {
    ...
    myWorker.onerror=function(error){function WorkerException(message){this.name="WorkerException"; this.message=message;}; throw new WorkerException('worker error. ')};
  }
